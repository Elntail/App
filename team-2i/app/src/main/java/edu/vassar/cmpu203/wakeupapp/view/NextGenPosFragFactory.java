...
public class NextGenPosFragFactory extends FragmentFactory{
        ...
        private static final String VIEW_PACKAGE = NextGenPosFragFactory.class.getPackage().getName(); // package where all all fragments reside
         ...
         */
        public NextGenPosFragFactory(MainActivity controller){
